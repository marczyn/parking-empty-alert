...
> ⚠️ **Advanced setup** — requires [git-clone install path](../../docs/INSTALLATION.md#two-installation-paths), not the pre-built AIO image. AIO image is single-camera Reolink only.
